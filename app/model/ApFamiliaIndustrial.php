...
class ApFamiliaIndustrial extends TRecord
{
    const TABLENAME  = 'ap_familia_industrial';
    const PRIMARYKEY = 'id';
    ...
    public function getHistoricoVendaItems()
    {
        ...
        $criteria->add(new TFilter('familia_industrial_id', '=', $this->id));
    ...
    public function get_historico_venda_item_venda_to_string()
    {
        ...
        $values = HistoricoVendaItem::where('familia_industrial_id', '=', $this->id)->getIndexedArray('venda_id','{venda->id}');
    ...
    public function get_historico_venda_item_grupo_estoque_to_string()
    {
        ...
        $values = HistoricoVendaItem::where('familia_industrial_id', '=', $this->id)->getIndexedArray('grupo_estoque_id','{grupo_estoque->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_historico_venda_item_subgrupo_estoque_to_string()
    {
        ...
        $values = HistoricoVendaItem::where('familia_industrial_id', '=', $this->id)->getIndexedArray('subgrupo_estoque_id','{subgrupo_estoque->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_historico_venda_item_familia_comercial_to_string()
    {
        ...
        $values = HistoricoVendaItem::where('familia_industrial_id', '=', $this->id)->getIndexedArray('familia_comercial_id','{familia_comercial->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_historico_venda_item_familia_industrial_to_string()
    {
        ...
        $values = HistoricoVendaItem::where('familia_industrial_id', '=', $this->id)->getIndexedArray('familia_industrial_id','{familia_industrial->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_ap_item_system_unit_to_string()
    {
        ...
        $values = ApItem::where('familia_industrial_id', '=', $this->id)->getIndexedArray('system_unit_id','{system_unit->name}');
        return implode(', ', $values);
    }
    ...
    public function get_ap_item_subgrupo_estoque_to_string()
    {
        ...
        $values = ApItem::where('familia_industrial_id', '=', $this->id)->getIndexedArray('subgrupo_estoque_id','{subgrupo_estoque->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_ap_item_grupo_estoque_to_string()
    {
        ...
        $values = ApItem::where('familia_industrial_id', '=', $this->id)->getIndexedArray('grupo_estoque_id','{grupo_estoque->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_ap_item_familia_comercial_to_string()
    {
        ...
        $values = ApItem::where('familia_industrial_id', '=', $this->id)->getIndexedArray('familia_comercial_id','{familia_comercial->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_ap_item_familia_industrial_to_string()
    {
        ...
        $values = ApItem::where('familia_industrial_id', '=', $this->id)->getIndexedArray('familia_industrial_id','{familia_industrial->descricao}');
        return implode(', ', $values);
    }
    ...
    public function onBeforeDelete()
    {
        ...
        if(HistoricoVendaItem::where('familia_industrial_id', '=', $this->id)->first())
        {
            throw new Exception("Não é possível deletar este registro pois ele está sendo utilizado em outra parte do sistema");
        }
    
        if(ApItem::where('familia_industrial_id', '=', $this->id)->first())
        {
            throw new Exception("Não é possível deletar este registro pois ele está sendo utilizado em outra parte do sistema");
        }
