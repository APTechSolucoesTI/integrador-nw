...
class SystemUsers extends TRecord
{
    ...
    public function get_aguardo_produto_system_unit_to_string()
    {
        ...
        $values = AguardoProduto::where('system_users_id', '=', $this->id)->getIndexedArray('system_unit_id','{system_unit->name}');
        return implode(', ', $values);
    }
    ...
    public function get_aguardo_produto_system_users_to_string()
    {
        ...
        $values = AguardoProduto::where('system_users_id', '=', $this->id)->getIndexedArray('system_users_id','{system_users->name}');
        return implode(', ', $values);
    }
    ...
    public function get_aguardo_produto_repres_to_string()
    {
        ...
        $values = AguardoProduto::where('system_users_id', '=', $this->id)->getIndexedArray('repres_id','{repres->id}');
        return implode(', ', $values);
    }
    ...
    public function get_aguardo_produto_ap_item_to_string()
    {
        ...
        $values = AguardoProduto::where('system_users_id', '=', $this->id)->getIndexedArray('ap_item_id','{ap_item->id}');
        return implode(', ', $values);
    }
    ...
    public function get_ap_representante_system_unit_to_string()
    {
        ...
        $values = ApRepresentante::where('system_users_id', '=', $this->id)->getIndexedArray('system_unit_id','{system_unit->name}');
        return implode(', ', $values);
    }
    ...
    public function get_ap_representante_system_users_to_string()
    {
        ...
        $values = ApRepresentante::where('system_users_id', '=', $this->id)->getIndexedArray('system_users_id','{system_users->name}');
        return implode(', ', $values);
    }
