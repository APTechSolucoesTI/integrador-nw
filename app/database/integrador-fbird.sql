...
CREATE TABLE trimestre_cliente_inicial( 
 ...
 CREATE UNIQUE INDEX unique_idx_persiana_agrupamento_nome ON persiana_agrupamento COMPUTED BY (nome);
...
ALTER TABLE campanha_item ADD CONSTRAINT campanha_item_6ab2d36a5c642 FOREIGN KEY (campanha_id) references campanha(id); 
...
ALTER TABLE persiana_agrupamento_excecao ADD CONSTRAINT persiana_agrupamento_excecao_6ab2d36a6186f FOREIGN KEY (persiana_agrupamento_id) references persiana_agrupamento(id); 
ALTER TABLE persiana_agrupamento_grupo ADD CONSTRAINT persiana_agrupamento_grupo_6ab2d36a61ae5 FOREIGN KEY (ap_grupo_estoque_id) references ap_grupo_estoque(id); 
ALTER TABLE persiana_agrupamento_grupo ADD CONSTRAINT persiana_agrupamento_grupo_6ab2d36a61b32 FOREIGN KEY (persiana_agrupamento_id) references persiana_agrupamento(id); 
...
ALTER TABLE planejamento_import_excecao ADD CONSTRAINT planejamento_import_excecao_6ab2d36a62095 FOREIGN KEY (planejamento_import_id) references planejamento_import(id); 
