SET IDENTITY_INSERT campanha_tipo ON; 

INSERT INTO campanha_tipo (id,nome) VALUES (1,'Quantidade'); 

INSERT INTO campanha_tipo (id,nome) VALUES (2,'Ranking'); 

SET IDENTITY_INSERT campanha_tipo OFF; 

SET IDENTITY_INSERT comparador ON; 
...
SET IDENTITY_INSERT comparador OFF; 

SET IDENTITY_INSERT mini_meta_tipo ON; 

INSERT INTO mini_meta_tipo (id,nome) VALUES (1,'Quantidade'); 

INSERT INTO mini_meta_tipo (id,nome) VALUES (2,'Valor'); 

SET IDENTITY_INSERT mini_meta_tipo OFF; 
...
SET IDENTITY_INSERT premio_regra ON; 
...
SET IDENTITY_INSERT premio_regra OFF; 

SET IDENTITY_INSERT regra_prospeccao ON; 
...
SET IDENTITY_INSERT regra_prospeccao OFF; 
...
SET IDENTITY_INSERT tipo_premio ON; 
...
SET IDENTITY_INSERT tipo_premio OFF; 
