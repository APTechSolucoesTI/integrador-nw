...
class ItemSeekWindow extends TWindow
{
    private $form; // form
    ...
    private static $database = 'nw';
    private static $activeRecord = 'Item';
    private static $primaryKey = 'cod_item';
    private static $formName = 'form_ItemSeekWindow';
    ...
    public function __construct($param = null)
    {
        ...
        $this->form->setFormTitle("Busca de Item");
        ...
        $row1 = $this->form->addFields([new TLabel("Código:", null, '14px', null, '100%'),$codigo]);
        ...
        $action_onSelect = new TDataGridAction(array('ItemSeekWindow', 'onSelect'));
    ...
    public function onReload($param = NULL)
    {
        try
        {
            // open a transaction with database 'nw'
            TTransaction::open(self::$database);
