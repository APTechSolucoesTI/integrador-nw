...
class ApTabelaPrecoHeaderList extends TPage
{
    private $form; // form
    ...
    public function __construct($param = null)
    {
        ...
        $id->exitOnEnter();
        $cod_tabelapreco->exitOnEnter();
        $descricao->exitOnEnter();
        $ativo->exitOnEnter();

        $id->setExitAction(new TAction([$this, 'onSearch'], ['static'=>'1', 'target_container' => $param['target_container'] ?? null]));
        $cod_tabelapreco->setExitAction(new TAction([$this, 'onSearch'], ['static'=>'1', 'target_container' => $param['target_container'] ?? null]));
        ...
        $column_cod_tabelapreco = new TDataGridColumn('cod_tabelapreco', "Cod tabelapreco", 'left');
        ...
        $action_onEdit = new TDataGridAction(array('ApTabelaPrecoForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('ApTabelaPrecoHeaderList', 'onDelete'));
        ...
        $tr->add($td_id);
        $td_cod_tabelapreco = TElement::tag('td', $cod_tabelapreco);
        $tr->add($td_cod_tabelapreco);
        ...
        $this->datagrid_form->addField($cod_tabelapreco);
        ...
        $panel = new TPanelGroup("Listagem de tabela preço");
        ...
        $button_sincronizar->setAction(new TAction(['ApTabelaPrecoHeaderList', 'onAtualizar']), "Sincronizar");
        ...
        $button_cadastrar->setAction(new TAction(['ApTabelaPrecoForm', 'onShow']), "Cadastrar");
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Configurações","Tabela Preço"]));
        }
    ...
    { 
        if(isset($param['delete']) && $param['delete'] == 1)
        {
            try
            {
                ...
                // instantiates object
                $object = new ApTabelaPreco($key, FALSE); 
    ...
    public function onAtualizar($param = null) 
    {
    try{
    ...
    public function onSearch($param = null)
    {
        ...
        if (isset($data->cod_tabelapreco) AND ( (is_scalar($data->cod_tabelapreco) AND $data->cod_tabelapreco !== '') OR (is_array($data->cod_tabelapreco) AND (!empty($data->cod_tabelapreco)) )) )
        {

            $filters[] = new TFilter('cod_tabelapreco', '=', $data->cod_tabelapreco);// create the filter 
        }
