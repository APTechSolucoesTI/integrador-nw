...
class STApTabelaPrecoSimpleList extends TPage
{
    ...
    public function __construct($param = null)
    {
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Metas","Listagem Tabela de Preco"]));
        }
        $container->add($panel);
    ...
    public function onShow($param = null)
    {
      ...
      Try{ 
        ...
        if ($mini_meta_id) {
            ...
            $ids_tabelas = MinimetaTabelaPreco::where('mini_meta_id', '=', $mini_meta_id)
                                ->where('fazparte', '=', 'S')
