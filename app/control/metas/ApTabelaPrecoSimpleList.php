...
class ApTabelaPrecoSimpleList extends TPage
{
    ...
    public function __construct($param = null)
    {
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Metas","Verificar Tabela Preço"]));
        }
        $container->add($panel);
    ...
    public function onShow($param = null)
    {
        ...
        if ($campanha_id) {
            ...
            $ids_tabelas = CampanhaTabelaPreco::where('campanha_id', '=', $campanha_id)
                                ->where('fazparte', '=', 'S')
